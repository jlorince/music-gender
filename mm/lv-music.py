...
THIS CODE MUST BE RUN IN A PYTHON 2.x ENVIRONMENT ON LINUX!!!
(largevis is not python 3 compatible, and I have never been able to get it working on Windows)
...
if __name__ == '__main__':
    ...
    if args.sampling == 'by_year' and args.years is None:
        raise Exception("You must specify a path to release year data.")
