...
result_path = args.result_dir+'_'.join([str(v) for v in [args.d2v_params,args.index_type,args.index_seed,args.knn,args.trees,args.search_k,args.songs_per_bin]])+'/'

Example:
100-5-5-0_global-norm_12345_1000_100_100000_None/
...
if __name__ == '__main__':
    ...
    parser.add_argument("--datadir",help="path to data directory",default='/backup/home/jared/lde-music-test/',type=str)
    ...
    #bin setup
    bin_args = map(int,args.bins.split('-'))
    bin_args[1]+=1
    ...
    if args.index_seed is not None:
        ...
        if args.d2v_params is not None:
            ...
            result_path = args.result_dir+'_'.join([str(v) for v in ['echonest',args.index_type,args.index_seed,args.knn,args.trees,args.search_k,args.songs_per_bin]])+'/'
